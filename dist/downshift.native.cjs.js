...
var validatePropTypes$1 = process.env.NODE_ENV === 'production' ? /* istanbul ignore next */null : getPropTypesValidator(useSelect, propTypes$1);
...
function getElementIds(_ref) {
  ...
  }, getElementIds$1(_extends__default["default"]({
    id: id
  }, rest)));
}
...
function downshiftUseComboboxReducer(state, action) {
  ...
  switch (type) {
    ...
    case InputKeyDownEnter:
      changes = _extends__default["default"]({}, state.highlightedIndex >= 0 && {
        selectedItem: props.items[state.highlightedIndex],
        isOpen: getDefaultValue$1(props, 'isOpen'),
        highlightedIndex: getDefaultValue$1(props, 'highlightedIndex'),
...
var validatePropTypes = process.env.NODE_ENV === 'production' ? /* istanbul ignore next */null : getPropTypesValidator(useCombobox, propTypes);
...
function useCombobox(userProps) {
  ...
  var getToggleButtonProps = react.useCallback(function (_temp4) {
    ...
    return _extends__default["default"]((_extends4 = {}, _extends4[refKey] = handleRefs(ref, function (toggleButtonNode) {
      toggleButtonRef.current = toggleButtonNode;
    }), _extends4.id = elementIdsRef.current.toggleButtonId, _extends4.tabIndex = -1, _extends4), !rest.disabled && _extends__default["default"]({}, /* istanbul ignore next (react-native) */{
